        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2 text-[#202125]">
              ...
              <span>
                Zip:{" "}
                {negotiationData[0] && negotiationData[0].negotiations_Zip_Code}
              </span>
            </div>
          </div>
          <div className="space-y-2">
            <div className="flex items-center space-x-2 text-[#202125]">
              ...
              <span>Deal Stage: {negotiationStatus}</span>
            </div>
            <div className="flex items-center space-x-2 text-[#202125]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <div className="relative w-full h-[400px]">
                      {isVimeoLink(dealNegotiatorData?.video_link ?? "") ? (
                        <iframe
                        ...
                        />
                      ) : isYouTubeLink(dealNegotiatorData?.video_link) ? (
                        <iframe
